...
function afterRun(time) {
    ...
    var seconds = (+runSeconds[0]) * 60 * 60 + (+runSeconds[1]) * 60 + (+
        runSeconds[2]);
    // End of copied code
...
var cal = currentUser.get("caloriesBurnt");
$(".parseuserCalories").html(cal);
var profilePicture = currentUser.get("ProfilePic");
$("#profilePicHolder").html(
    "<img id='profilePicture' height='90' width='90' src=" + profilePicture +
    ">");
if (currentUser.get("ProfilePic") == undefined) {
    $("#profilePicHolder").html(
        "<img id='profilePicture' height='90' width='90' src='resources/img/default.jpg'>"
    );
}
